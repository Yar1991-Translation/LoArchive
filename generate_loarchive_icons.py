...
def create_loarchive_icon(size):
    ...
    draw.rounded_rectangle([book_left, book_top, book_left + spine * 1.5, book_bottom], radius=spine_radius, fill=white)

    # 书页（右侧矩形）
    draw.rectangle([book_left + spine, book_top, book_right, book_bottom], fill=white)
    ...
    draw.rectangle(
        [
            book_left + spine + book_w * 0.08,
            book_bottom - page_gap * 2,
            book_right - book_w * 0.08,
            book_bottom - page_gap * 1.7,
        ],
        fill=line_color,
    )
    ...
    draw.rectangle(
        [
            book_left + spine + book_w * 0.08,
            book_bottom - page_gap,
            book_right - book_w * 0.08,
            book_bottom - page_gap * 0.7,
        ],
        fill=line_color,
    )
